        ...
        <div className="mt-16 text-center">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-200 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="inline-flex items-center gap-2 bg-slate-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-slate-700 transition-colors shadow-lg">
                Download Technical Manual
                <DownloadIcon />
              </button>
              <button className="inline-flex items-center gap-2 bg-white text-slate-600 px-6 py-3 rounded-full font-semibold border-2 border-slate-500 hover:bg-slate-50 transition-colors">
                View CAD Files
